//Write a Java Program to create three user defined exceptions named HrsException, MinException, and SecException.
//Create a class Time that contains data members hours, minutes, seconds and throw the user defined exceptions if hours > 24 
//OR hours < 0, minutes > 60 OR minutes < 0, seconds > 60 OR seconds < 0. Then demo class using suitable try…catch block to 
//catch those exceptions in your program.
